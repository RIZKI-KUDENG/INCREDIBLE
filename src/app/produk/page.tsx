...
export default function ProdukPage() {
  ...
  const [tipe, setTipe] = useState('bunga');
  ...
  return (
    ...
    <div className="container mx-auto p-6 ">
      ...
      <div className="mb-6 space-y-4">
        ...
        >
          <option value="biasa">Kategori Biasa</option>
        ...
        <table className="w-full table-auto border-collapse">
          <thead>
            <tr className="border-b">
              ...
              <th className="py-3 px-4 text-left text-sm font-medium">Tipe</th>
          ...
          <tbody>
            {produk.map((p: any) => (
              <tr key={p.id} className="border-b">
                ...
                <td className="py-3 px-4 text-sm ">{p.tipe}</td>
